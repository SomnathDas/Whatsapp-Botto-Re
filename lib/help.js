...
*_CMD: ${prefix}pokemon <pokemon name>_*
*Description: Returns the details of the given pokemon name* 😺️

*_CMD: ${prefix}haigusha_*
*Description: Returns picture and info of a random anime character* 💌️
